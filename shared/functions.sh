...
check_privacy() {
  ...
  echo "Telemetry Blocking: $(env | grep -cE '^(TELEMETRY|DO_NOT_TRACK|ANALYTICS|DISABLE_TELEMETRY|NO_UPDATE_NOTIFIER|NEXT_TELEMETRY_DISABLED|DOTNET_CLI_TELEMETRY_OPTOUT|HOMEBREW_NO_ANALYTICS)=' || true) variables set"
